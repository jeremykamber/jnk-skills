...
**Fits:** standalone, like commit/debug — not a numbered beat. Sits after jnk-4-verify; small found bugs are fixed inline, large ones escalate to jnk-debug / the beats; history via jnk-commit.
