...
When cleared, the first beat is /skill:jnk-0-resume (continuing work) or /skill:jnk-1-understand (fresh). Do not start it: the first beat begins when the user invokes it.
