...
When cleared, the first beat is /skill:jnk-pickup (continuing work) or /skill:jnk-1-explore (fresh). Do not start it: the first beat begins when the user invokes it.
