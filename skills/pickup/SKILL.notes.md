...
**What:** Pick up where a previous session left off. Finds the work in the engineering notebook, reads what was learned and what's unfinished, presents the state before any beat starts.

**When:** continuing prior work, before the first beat — skip when starting fresh.
