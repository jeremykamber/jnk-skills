---
name: debrief
description: Close a session like a pilot closes a flight. User-invoked only via /skill:debrief. Writes the session log: what landed, squawks, IOUs reconciled, and the next leg.
